<template>
    <div class="pic">
        <div class="pic_left">
            <div class="pic_item">
                ...
                <div class="zi">真的官方验</div>
            </div>
            <div class="pic_item">
                <i class="iconfont icon-xiangji"></i>
                <div class="zi">真图实拍</div>
            </div>
            <div class="pic_item">
                <i class="iconfont icon-dunpai"></i>
                <div class="zi">专业平台质保</div>
            </div>
        </div>
        <div class="pic_right">
    ...
    <div class="categorize">
            <ul>
                <li
                v-for="item in categoryNavSide" 
                :key="item.categoryId"
                v-text="item.name"
                v-show="categoryNavSide"
                class="nav-side"
                ...
                <div class="swiper_wrapper">
                    <template v-for="(category, index) in categoryContent">
                        <div class="swiper_slide" 
                            ...
                            v-for="(products, index) in category.categorycontainer"
                            :key="index">
                                <div class="picture">
                            ...
                            <div class="body">
                                ...
                                <div class="categorybottom"
                                    v-for="(body,index) in category.categorybody"
                                    :key="index">
                                    <div class="picture_1">
